/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a7304b180663715fa86601bc812eae21)
...
interface __BaseEnv_Env {
	...
	TEST_SUPPLIER_PIB: string;
	TEST_CUSTOMER_PIB: string;
	KLIJENT_BAZA_OBJECT: DurableObjectNamespace<import("./worker/index").KlijentBaza>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "KlijentBaza";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SEF_API_URL" | "SEF_PPPPDV_URL" | "STAGING_SEF_API_KEY" | "SESSION_SECRET" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_ZONE_ID" | "TELEGRAM_BOT_TOKEN" | "TELEGRAM_CHAT_ID" | "TEST_SUPPLIER_PIB" | "TEST_CUSTOMER_PIB">> {}
}
