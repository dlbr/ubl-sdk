...
describe('Billing Ledger v3.5.0 — Transactional Mathematics Audit', () => {
  ...
  it('Treba da izvrši REFUNDACIJU kredita kada stigne webhook status Rejected', async () => {
    ...
    await app.request('/api/fakture/send', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json', 'X-Klijent-ID': kId },
      body: JSON.stringify({ ID: "LEDGER-2", IssueDate: "2026-05-21", DueDate: "2026-05-30", InvoiceTypeCode: "380", DocumentCurrencyCode: "RSD", Supplier: { Pib: "123456789", Name: "Test", Address: { City: "BG", CountryCode: "RS" } }, Customer: { Pib: "987654321", Name: "Kupac", Address: { City: "BG", CountryCode: "RS" } }, LegalMonetaryTotal: { LineExtensionAmount: 100, TaxExclusiveAmount: 100, TaxInclusiveAmount: 120, AllowanceTotalAmount: 0, PrepaidAmount: 0, PayableRoundingAmount: 0, PayableAmount: 120 }, Lines: [] })
    }, env, mockCtx as any);
  ...
  it('Treba da spreči duplu refundaciju (Idempotency Audit)', async () => {
    ...
    await app.request('/api/fakture/send', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json', 'X-Klijent-ID': kId },
      body: JSON.stringify({ ID: "LEDGER-3", IssueDate: "2026-05-21", DueDate: "2026-05-30", InvoiceTypeCode: "380", DocumentCurrencyCode: "RSD", Supplier: { Pib: "123456789", Name: "Test", Address: { City: "BG", CountryCode: "RS" } }, Customer: { Pib: "987654321", Name: "Kupac", Address: { City: "BG", CountryCode: "RS" } }, LegalMonetaryTotal: { LineExtensionAmount: 100, TaxExclusiveAmount: 100, TaxInclusiveAmount: 120, AllowanceTotalAmount: 0, PrepaidAmount: 0, PayableRoundingAmount: 0, PayableAmount: 120 }, Lines: [] })
    }, env, mockCtx as any);
